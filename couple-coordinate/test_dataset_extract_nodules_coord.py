...
lungs_coordinate_file = output_path + "val_data_images/csv/imgs_mask_test_coordinate_3D.csv"

annotations_file = output_path + "val_data_images/csv/imgs_mask_test_annotations.csv"
