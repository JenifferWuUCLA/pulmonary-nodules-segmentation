...
def csv_cmp_row(seriesuid, true_coordX, true_coordY, true_coordZ, true_diameter_mm, pred_coordX, pred_coordY,
...
def csv_MSE_row(seriesuid, true_coordX, true_coordY, true_coordZ, true_diameter_mm, pred_coordX, pred_coordY,
                pred_coordZ, pred_diameter_mm):
    new_row = []
...
csv_cmp_row("seriesuid", "true_coordX", "true_coordY", "true_coordZ", "true_diameter_mm", "pred_coordX", "pred_coordY",
            "pred_coordZ", "pred_diameter_mm")

csv_row("seriesuid", "avg_error", "avg_error_ratio", "coordX-error", "coordY-error", "coordZ-error",
        "diameter_mm-error", "X_error_ratio", "Y_error_ratio", "Z_error_ratio", "diam_error_ratio")

csv_MSE_row("seriesuid", "true_coordX", "true_coordY", "true_coordZ", "true_diameter_mm", "pred_coordX", "pred_coordY",
            "pred_coordZ", "pred_diameter_mm")
...
for stat_row in stat_csvRows:
    ...
    if condition_1 or condition_2:
        csv_cmp_row(seriesuid, true_coordX, true_coordY, true_coordZ, true_diameter_mm, pred_coordX, pred_coordY,
                    pred_coordZ, pred_diameter_mm)
        csv_row(seriesuid, avg_error, avg_error_ratio, coordX_error, coordY_error, coordZ_error, diameter_mm_error,
                X_error_ratio, Y_error_ratio, Z_error_ratio, diam_error_ratio)
        csv_MSE_row(seriesuid, true_coordX, true_coordY, true_coordZ, true_diameter_mm, pred_coordX, pred_coordY,
                    pred_coordZ, pred_diameter_mm)
