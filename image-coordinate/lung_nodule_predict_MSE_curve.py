...
print('Mean Square Error of CoordX: {:.3f}'.format(coordX_MSE))
print('Mean Square Error of CoordY: {:.3f}'.format(coordY_MSE))
print('Mean Square Error of CoordZ: {:.3f}'.format(coordZ_MSE))
print('Mean Square Error of Diameter_mm: {:.3f}'.format(diameter_mm_MSE))