...
original_nodule_path = os.path.join(original_output_path, "val/")
crop_nodule_path = os.path.join(crop_output_path, "val/")

val_images = glob(os.path.join(original_output_path, "val/PULMONARY_NODULES_pred_p_*.jpg"))
